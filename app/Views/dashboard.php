    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        a.button {
            ...
            text-decoration: none; background: #f0e6d3;
            color: #3d2b1f; font-size: 0.9rem; cursor: pointer;
            transition: background 0.2s;
        }
        a.button:hover { background: #e0d0b8; }
        a.button.danger { background: #fdecea; border-color: #e0a0a0; color: #b30000; }
        a.button.danger:hover { background: #f5c6cb; }
        .welcome, .cards, .container-top { max-width: 1100px; margin: 0 auto; }
        .welcome {
            margin-bottom: 32px; background: #fffdf7;
            border-radius: 16px; padding: 24px 32px;
            box-shadow: 0 4px 20px rgba(0,0,0,0.08);
            color: #3d2b1f; font-size: 1.1rem;
        }
        ...
        .card {
            background: #fffdf7; border-radius: 16px; padding: 24px 10px;
            box-shadow: 0 4px 20px rgba(0,0,0,0.08);
        ...
        .card:hover { background: #f0e6d3; transform: translateY(-2px); }
        .card .icon { font-size: 2rem; }
        .card .label { font-weight: 600; font-size: 0.9rem; text-align: center; }
