...
<head>
    <meta charset="utf-8">
    <title><?= htmlspecialchars($title ?? 'Modifier un visiteur') ?></title>
    ...
    <form action="../../visiteur/<?= $visiteur['ID'] ?>/edit" method="post">
        ...
        <div class="field">
            ...
            <input type="text" name="nom" id="nom"
                   value="<?= htmlspecialchars($old['nom'] ?? '', ENT_QUOTES) ?>" required>
        ...
        <div class="field">
            ...
            <input type="text" name="prenom" id="prenom"
                   value="<?= htmlspecialchars($old['prenom'] ?? '', ENT_QUOTES) ?>" required>
        ...
        <div class="field">
            ...
            <input type="text" name="adresse" id="adresse"
                   value="<?= htmlspecialchars($old['adresse'] ?? '', ENT_QUOTES) ?>" required>
        ...
        <div class="field">
            ...
            <input type="text" name="ville" id="ville"
                   value="<?= htmlspecialchars($old['ville'] ?? '', ENT_QUOTES) ?>" required>
        ...
        <div class="field">
            ...
            <input type="text" name="cp" id="cp"
                   value="<?= htmlspecialchars($old['cp'] ?? '', ENT_QUOTES) ?>" required>
        ...
        <div class="field">
            ...
            <input type="date" name="date_embauche" id="date_embauche"
                   value="<?= htmlspecialchars($old['date_embauche'] ?? '', ENT_QUOTES) ?>" required>
