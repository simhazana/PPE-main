...
<div class="container">
    ...
    <?php if (!empty($etat)): ?>
        <div class="card">
            <div class="card-header">Informations de l'état</div>
            <div class="card-row">
                <span class="card-label">ID</span>
                <span class="card-value"><?= htmlspecialchars($etat['id']) ?></span>
            </div>
            <div class="card-row">
                <span class="card-label">Libellé</span>
                <span class="card-value"><?= htmlspecialchars($etat['libelle']) ?></span>
            </div>
        </div>
