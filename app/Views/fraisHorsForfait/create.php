...
<head>
    <meta charset="utf-8">
    <title><?= htmlspecialchars($title ?? 'Créer un frais hors forfait') ?></title>
...
<div class="container">
    ...
    <form action="../fraisHorsForfait/create" method="post">

        <div class="field">
            <label for="libelle">Libellé *</label>
            <input type="text" name="libelle" id="libelle" maxlength="100"
                   value="<?= htmlspecialchars($old['libelle'] ?? '') ?>" required>
        ...
        <div class="field">
            ...
            <input type="number" name="montant" id="montant" min="0" step="0.01"
        ...
        <div class="form-actions">
            ...
            <a class="button" href="../fraisHorsForfait">Annuler</a>
        </div>
