...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .container { max-width: 960px; margin: 0 auto; background: #fffdf7; border-radius: 16px; padding: 32px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); }
...
<body>
    ...
    <a class="button add" href="./fraisHorsForfait/create">➕ Ajouter un frais hors forfait</a>
    ...
    <?php if (empty($fraisHorsForfait)): ?>
        <p style="color:#888;font-style:italic;margin-top:16px;">Aucun frais hors forfait trouvé.</p>
    <?php else: ?>
        <table>
            <thead>
                <tr>
